...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    /**
     * Analogy: Think of overrides like a "special rule" you add to a general law.
     * The general law says "check every request for a token".
     * This override says "except if the request is going to /auth/**, skip the check".
     */
    @Override
